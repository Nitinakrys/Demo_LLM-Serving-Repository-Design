...
`Qa` branch has the equivalent `qa/gemma-4-31b-it.env`, `qa/medgemma-1.5-4b-it.env`, `qa/medgemma-27b-it.env` instead of `dev/`. `main` branch has `main/` with the same three files, tuned for its H200 GPU.
